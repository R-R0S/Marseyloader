...
cp -r SS14.Launcher/bin/Release/net10.0/win-x64/publish/* bin/publish/Windows/bin
cp -r SS14.Loader/bin/Release/net10.0/win-x64/publish/* bin/publish/Windows/bin/loader
