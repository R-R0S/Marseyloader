...
cp -r SS14.Launcher/bin/Release/net10.0/linux-x64/publish/* bin/publish/Linux/bin/
cp -r SS14.Loader/bin/Release/net10.0/linux-x64/publish/* bin/publish/Linux/bin/loader
